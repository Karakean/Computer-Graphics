...
HRESULT InitDevice()
{
    ...
    SimpleVertex vertices[MAX_NUMBER/10] =
    {

        { XMFLOAT3(-0.5f, 1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-1.0f, 1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-1.0f, -1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-0.5f, -1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-0.5f, 0.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f, -1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.5f, -1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f, 0.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.5f, 1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(0.0f, 1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-0.5f, 0.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
        { XMFLOAT3(-0.5f, 1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },
    ...
    int front_vertices_num = 12;
	g_nVertices = 2*front_vertices_num;

    for (int i = front_vertices_num; i < g_nVertices; i++) {
        vertices[i] = vertices[i - front_vertices_num];
        vertices[i].Pos.z *= -1;
        vertices[i].Normal.z *= -1;
    }

	WORD indices[MAX_NUMBER] =
	{
		0, 1, 4,
        1, 4, 2,
        2, 3, 4,
    ...
    g_nTriangles = 6;
    int indices_num = 3 * g_nTriangles;

    //rear wall
    for (int i = 0; i < indices_num; i++) {
        indices[i + indices_num] = indices[i] + front_vertices_num;
    }indices_num *= 2;

    g_nTriangles = indices_num / 3;

    //welding
    for (int i = 0; i < front_vertices_num; i++) {
        indices[indices_num] = i;
        indices[indices_num + 1] = i + 1;
        indices[indices_num + 2] = i + front_vertices_num;

        indices[indices_num + 3] = i + front_vertices_num;
        indices[indices_num + 4] = i + front_vertices_num + 1;
        indices[indices_num + 5] = i + 1;
        indices_num += 6;
        g_nTriangles+=2;
    }
...
void Render()
{
	...
	XMVECTOR Eye = XMVectorSet(gx/100, 2.0f + gy / 100, 4.0f , 0.0f);
